...
public class SM2Utils 
{
	...
	public static void generateKeyPair() {
		...
		PrintUtil.println("公钥: " + sm2PubliKey);
		PrintUtil.println("私钥: " + sm2PrivateKey);
	}
...
//	    Log.i(MainActivity.TAG,"生成的签名值------"+Util.byteToHex(signdata));
	...
	public static boolean verifySign(byte[] userId, byte[] publicKey, byte[] sourceData, byte[] signData) throws IOException
	{
	    ...
	    byte[] md = new byte[32];
	    sm3.doFinal(md, 0);
		PrintUtil.println("SM3摘要值-----"+ Util.getHexString(md));
...
//		String prik = "128B2FA8BD433C6C068C8D803DFF79792A519A55171B1B650C23661D15897263";
		String prik = SM2Utils.sm2PrivateKey;
		...
		PrintUtil.println("生成的签名证书----"+ Util.getHexString(c));
...
//		String pubk = "040AE4C7798AA0F119471BEE11825BE46202BB79E2A5844495E97C04FF4DF2548A7C0240F88F1CD4E16352A73C17B7F16F07353E53A176D684A9FE0C6BB798E857";
		String pubk = SM2Utils.sm2PubliKey;
...
//		System.out.println("加密: ");
		...
		PrintUtil.println("加密后的数据----"+new String(Base64.encode(cipherText)));
		System.out.println("");

//		System.out.println("解密: ");
		plainText = new String(SM2Utils.decrypt(Base64.decode(prikS.getBytes()), cipherText));
		PrintUtil.println("解密后的数据----"+plainText);
